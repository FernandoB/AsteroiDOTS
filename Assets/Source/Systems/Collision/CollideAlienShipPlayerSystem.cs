...
public class CollideAlienShipPlayerSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        {
            alienShipData = GetComponentDataFromEntity<AlienShipData>(),
    ...
    {
        [ReadOnly] public ComponentDataFromEntity<AlienShipData> alienShipData;
        ...
        {
            if (alienShipData.HasComponent(entityA)
